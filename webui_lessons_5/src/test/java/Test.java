...
public class Test {
    ...
    private void createContactPerson() {
        ...
        //Не выходит добраться до выбора организации,пробовала нескончаемое колличество путей

       /* WebElement choiceCompany = driver.findElement(By.xpath("//div[@class='loader-mask']/ul[@class='select2-results']/div[text()='1234']"));
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
        choiceCompany.click();*/

        /*При вводе в процессе теста значения менеджер пишет,что совпадений не найдено,
        хотя при вводе от руки никакие варианты не появляются и подтвержение совпадений не требуется.*/
